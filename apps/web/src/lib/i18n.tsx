...
const en = {
  ...
  'nav.profile': 'Profile',
  'nav.adminStats': 'Site stats',
  'nav.adminViews': 'Access records',
  ...
  'admin.stats.title': 'Site statistics',
  'admin.stats.description': 'Users, pastes and access activity across the site.',
  'admin.stats.users': 'Users',
  'admin.stats.pastes': 'Pastes',
  'admin.stats.totalViews': 'Total views',
  'admin.stats.recent': 'Recent views',
  'admin.stats.allViews': 'View all',
  'admin.stats.top10': 'Top 10 pastes by views',
  'admin.stats.colPaste': 'Paste',
  'admin.stats.colViews': 'Views',
  'admin.views.title': 'Access records',
  'admin.views.description': 'All paste access records across the site, filterable by country, IP and time range.',
  'admin.views.filterUser': 'User',
  'admin.views.noUsers': 'No matching users',
...
const zh: Record<TranslationKey, string> = {
  ...
  'admin.stats.description': '全站用户、粘贴与访问活动总览。',
  'admin.stats.users': '用户数',
  'admin.stats.pastes': '粘贴数',
  'admin.stats.totalViews': '总访问次数',
  'admin.stats.recent': '最近访问',
  'admin.stats.allViews': '查看全部',
  'admin.stats.top10': '访问次数 Top 10',
  'admin.stats.colPaste': '粘贴',
  'admin.stats.colViews': '访问次数',
  'admin.views.title': '访问记录',
  'admin.views.description': '全站粘贴访问记录，可按国家、IP 与时间范围筛选。',
  'admin.views.filterUser': '访问用户',
  'admin.views.noUsers': '没有匹配的用户',
